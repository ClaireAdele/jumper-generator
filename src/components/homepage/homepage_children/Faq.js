  ...
  return (
    <div id="faq">
      <div className="faq-container">
        <h2>What type of pattern will I be able to generate? </h2>
        ...
        <p className="faq-answer">
          ...
          own manually, or pick a standardised amount. Over time, I am hoping to
      ...
      <div className="faq-container">
        <h2>What system do you use to calculate the patterns?</h2>
        <p className="faq-answer">
          This website mostly relies on{" "}
          <b>
            Elizabeth’s Zimmerman’s approach to calculate the size of the jumper
          </b>
        ...
        <p>
          It’s based on{" "}
          <b>percentages to keep the whole garment proportional</b>, and yields
          great results! I also offer extra customisation options, such, for
          instance, using your wrists, arms and shoulders measurements to go off
          instead of a percentage of the body if you’d prefer.
        </p>
      </div>

      <div className="faq-container">
        <h2>How detailed/beginner-friendly will the patterns be?</h2>
        <p className="faq-answer">
          The patterns produced are <b>beginner-friendly</b>, and{" "}
          <b> explain all the construction steps</b>, so you could use this
          generator for <b>your first jumper!</b> I would recommend picking the
          top-down raglan jumper pattern if this is your first foray into
          knitting a jumper - they are very easy to adjust as you go, as you can
          try them on as you knit them. I will try my best to provide your with
          links to videos explaining the techniques used as well.
        </p>
        <p>
          Alternatively,{" "}
          <b>
          ...
          , I will put down all the stitch numbers/pieces sizes/etc. at the top
      ...
      <div className="faq-container">
        ...
        <p className="faq-answer">
          Creating an account will let you <b>save the patterns you generate</b>
          , as well as <b>your measurements</b>, so that it's even{" "}
          <b>
            easier to use the generator the next time, or try different pattern
